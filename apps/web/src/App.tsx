...
import { LandingEditorVersionPage } from './pages/LandingEditorVersionPage'
...
export default function App() {
  return (
    <Routes>
      ...
      <Route
        path="/admin/landing-editor/:projectId/version/:versionId/edit"
        element={<LandingEditorVersionPage />}
      />
      <Route
